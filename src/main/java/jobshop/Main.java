...
public class Main {
    ...
    static {
        ...
        solvers.put("spt", new GreedySolver(GreedySolver.modes.SPT));
        solvers.put("lpt", new GreedySolver(GreedySolver.modes.LPT));
        solvers.put("srpt", new GreedySolver(GreedySolver.modes.SRPT));
        solvers.put("lrpt", new GreedySolver(GreedySolver.modes.LRPT));
        solvers.put("est_spt", new GreedySolver(GreedySolver.modes.EST_SPT));
        solvers.put("est_lrpt", new GreedySolver(GreedySolver.modes.EST_LRPT));
